...
export default function Welcome({
    ...
    return (
        <>
            <nav className="sticky top-0 x-50 py-3 backdrop-blur-lg border-neutral-700/80 bg-sky-600">
            ...
            <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
                <div className="text-center">
                    <span className="bg-neutral-400 text-indigo-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase ">
                        NOSSA EQUIPE
                    </span>
            ...
            <div className="mt-10 tracking-wide">
                ...
                <div className="flex flex-wrap justify-center">
                    {Clientes.map((Clientes) => (
                        ...
                        >
                            <div className="bg-neutral-300 rounded-md p-6 text-md border border-800 font-thin">
                                <p>{Clientes.text}</p>
            ...
            <footer className="relative text-neutral-500">
                <div className="absolute top-0 left-0 w-full overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-4 md:grif-cols-2 grid-cols-1 p-20">
                        <div className="flex flex-col gap-5">
                            <h2 className="text-3xl text-indigo-500 uppercase">Sobre:</h2>
                            <p>ALGO AQ</p>
                        </div>
                        <div className="flex flex-col gap-5">  
                            <ul>
                                <li className="text-[22px] list-none font-semibold text-indigo-500 py-2 uppercase">CONTATO:</li>
                                <li className="my-4 list-none">(19) 99377-2137</li>
                                <li className="my-4 list-none">(19) 99291-4156</li>
                                <li className="my-4 list-none">(19) 98470-3051</li>
                            </ul>
                        </div>
                        
                        <div className="flex flex-col gap-5">  
                            <ul>
                                <li className="text-[22px] list-none font-semibold text-indigo-500 py-2 uppercase">LOCALIZAÇÃO:</li>
                                <li className="my-4 list-none"> CEP: 13098-309</li>
                                <li className="my-4 list-none">Endereço: Rua Tapiriri</li>
                                <li className="my-4 list-none">Loteamento Alphaville Campinas</li>
                                <li className="my-4 list-none">Cidade: Campinas-SP </li>
                            </ul>
                        </div>
                        <div className="flex flex-col gap-5">
                            <h2 className="text-3xl text-indigo-500">Sobre:</h2>
                            <p>ALGO AQ</p>
                        </div>
                    </div>
                </div>
